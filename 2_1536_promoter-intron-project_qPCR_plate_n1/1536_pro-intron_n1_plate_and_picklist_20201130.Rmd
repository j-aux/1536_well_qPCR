---
title: "1536_plate_plan for promoter-intron swaps strains"
...
Primer mix
  ...
  - 30 ul of the primer mix is loaded to column 10

cDNA
  - For +RT wells
        - So the +RT cDNA is diluted 1:4 and 50 ul of each cDNA is loaded to column 6 and 7 
  - For -RT wells
        - So the -RT cDNA is diluted 1:4 and 50 ul of each cDNA is loaded to column 8 and 9 
...
primer_rowkey <- data.frame(
                     ...
                     target_id=Names)
# Primer colkey
primer_colkey <- data.frame(well_col = 10)
...
cdna_rowkey_1 <- data.frame(
                     ...
                     prep_type=c("+RT"))
# cDNA colkey_1
cdna_colkey_1 <- data.frame(well_col = 6)
...
cdna_rowkey_2 <- data.frame(
                     ...
                     prep_type=c("+RT"))
# cDNA colkey_2
cdna_colkey_2 <- data.frame(well_col = 7)
...
cdna_rowkey_3 <- data.frame(
                     ...
                     prep_type=c("-RT"))
# cDNA colkey_3
cdna_colkey_3 <- data.frame(well_col = 8)
...
cdna_rowkey_4 <- data.frame(
                     ...
                     prep_type=c("-RT"))
# cDNA colkey_4
cdna_colkey_4 <- data.frame(well_col = 9)
...
cat(
"# qPCR-picklist-2020-11-30-Echo-1536_pro-intron_n1.txt
...
generate_picklist(qpcr_plate_well_map, here("qPCR-picklist-2020-11-30-Echo-1536_pro-intron_n1.txt"))
```
